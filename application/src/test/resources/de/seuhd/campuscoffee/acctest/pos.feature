Feature: Points of Sale Management
  ...
  Scenario: Update one of three existing POS
    ...
    When I change the description of the POS called "Schmelzpunkt" to "Great coffee"
    
    Then the POS element called "Schmelzpunkt" should have the description "Great coffee"